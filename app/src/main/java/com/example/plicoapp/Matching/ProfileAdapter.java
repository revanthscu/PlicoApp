...
public class ProfileAdapter extends ArrayAdapter<Cards> {
    private int resourceId;
    private Context mContext;

    public ProfileAdapter(@NonNull Context context, int resource, @NonNull List<Cards> objects) {
